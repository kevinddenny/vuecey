        ...
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                ...
                <div class="sidebar-item sidebar-brand">
                    <router-link to="/" href="#">{{hname}}</router-link>
                ...
                <div class="sidebar-item sidebar-header">
                    <div class="user-pic">
                        <img class="img-responsive img-rounded" :src="profileUrl" alt="User picture">
                    </div>
                    <div class="user-info">
                ...
                <div class=" sidebar-item sidebar-menu">
                    <ul>
                        ...
                        <!-- <li>
                            <router-link to="/hotelpage/booking">
                        ...
                        <li>
                            <router-link to="/hotelpage/hotelprofile">
                                <i class="fa fa-user"></i>
                                <span class="">Hotel Profile</span>
                            </router-link>
                        </li>

                        <li>
                            <router-link to="/hotelpage/hotelpackages">
                        ...
                        <li>
                            <router-link to="/hotelpage/hotelsettings">
   ...
   var user = firebase.auth().currentUser;
    if (user != null){
       db.collection('hotel_bios').doc(user.uid).get().then(doc => {
        this.profileUrl=doc.data().profilepic
       
       });
      this.email = user.email;
    db.collection('hotel_profiles').doc(user.uid).get().then(doc => {
      this.name=doc.data().rep_name,
